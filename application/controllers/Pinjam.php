...
class Pinjam extends CI_Controller
{
  ...
  public function bookingDetail()
  {
    ...
    $data['detail'] = $this->db->query("select id_buku, judul_buku, pengarang, penerbit, tahun_terbit from booking_detail d, buku d where d.id_buku = b.id and d.id_booking = '$id_booking'")->result_array();
